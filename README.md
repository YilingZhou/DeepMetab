# DeepMetab
DeepMetab is an end-to-end, integrated metabolic characterization prediction model based on multi-task strategy and multi-scale features. This model provides comprehensive predictions about metabolic enzymes, metabolic sites, and metabolites for specified molecules. The methodology is described in detail in the paper. You can also use our model directly on our online platform, DeepCYP: https://deepcyp.scbdd.com/.
## Installation
``` python
